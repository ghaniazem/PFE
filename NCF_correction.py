...
#matrix = pd.DataFrame(0, index=user_ids, columns=common_movie_ids)
...
# Entraînement du modèle
neumf_model.fit([train_data['user_id'], train_data['movie_id']], train_data['rating'], epochs=10, batch_size=256, validation_split=0.2)
